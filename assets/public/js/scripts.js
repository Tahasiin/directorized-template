...
function(e) {
    ...
    var r = n(2),
        i = r.dom,
        o = "body",
        a = '<div id="topbar">\n            <div id="toolbar"></div>\n            <div id="flowbar"></div>\n            <a id="backlink" href="http://ex.discoveryftp.net" title="Discovery Internet - http://ex.discoveryftp.net">\n                <div>Discovery</div>\n                <div>Internet</div>\n            </a>\n        </div>',
        s = '<div id="mainrow">\n            <div id="content"></div>\n        </div>',
        c = function() {
    ...
    (function(t) {
        ...
        var B = function(e, t, n) {
            ...
            R = function() {
                ...
                }).on("mousedown", P).on("mousemove", P).on("keydown", P).on("keypress", P), a("#pv-spinner").hide(), a("#pv-bar-prev, #pv-prev-area").on("click", M), a("#pv-bar-next, #pv-next-area").on("click", E), a("#pv-bar-close").on("click", $), a("#pv-bar-fullscreen").on("click", D), a(p).on("resize", _).on("load", _))
            };
        e.exports = {
            setLabels: A,
            register: B,
